...
//        MyImage.fitWidthProperty().bind(HeadStagePane.widthProperty());
    ...
    public void music() throws URISyntaxException {
        if (mediaPlayer==null){
            String s = "/clips/icy_tower.mp3";
            Media h = new Media(MyViewController.class.getResource(s).toURI().toString());
    ...
    public void win_music() throws URISyntaxException {
        if (winMedia==null){
            String s = "/clips/YXFBY9J-win.mp3";
            Media h = new Media(MyViewController.class.getResource(s).toURI().toString());
